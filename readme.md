...
- to list the sturcture, navigate to your desired directory and use this command `tree /F /A > backend_structure.txt`
- This command does the following:
  ...
  - `> directory_structure.txt`: Redirects the output to a text file named "directory_structure.txt"
