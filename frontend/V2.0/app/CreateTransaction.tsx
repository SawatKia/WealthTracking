...
import { View, Text, TextInput, StyleSheet, Button, TouchableOpacity,SafeAreaView,Pressable } from 'react-native';
...
export default function CreateTransaction() {
    ...
    const [selectedAccountItem, setSelectedAccountItem] = useState<{ label: string; value: string }[]>([]); 
    ...
    <SafeAreaView >
      ...
      <View style={styles.container}>
        ...
        <View style={styles.rowInput}>
          ...
          <View style={styles.inputsContainer}>
              <TouchableOpacity style={styles.inputButton} onPress={()=>setDatePickerVisibility(!isDatePickerVisible)}>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.rowInput}>
          ...
          <View style={styles.inputsContainer}>
            <Link href="/CategoryExpenses" asChild>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.rowInput}>
        <View style={[styles.inputsContainer, {height: isAccountPickerVisible ? 150 : null}]}>
          <DropDownPicker
      ...
      <View style={styles.container}>
        ...
        <View style={styles.rowInput}>
          ...
          <View style={styles.inputsContainer}>
              <TextInput style={[styles.inputButton, {backgroundColor:'#9AC9F357'}]}returnKeyType="done"/>
